...
const SectionIntro = ({ eyebrow, title, description, action }) => (
  <div className="mb-10 flex flex-col gap-5 lg:mb-14 lg:flex-row lg:items-end lg:justify-between">
    <div className="max-w-3xl space-y-4">
      <div className="inline-flex rounded-full border border-border bg-muted px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-primary" data-testid={`section-eyebrow-${eyebrow.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`}>
        {eyebrow}
      </div>
      <h2 className="font-heading text-4xl font-semibold tracking-tight text-foreground sm:text-5xl" data-testid={`section-title-${title.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`}>
        {title}
      </h2>
      <p className="max-w-2xl text-base leading-8 text-muted-foreground sm:text-lg" data-testid={`section-description-${eyebrow.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`}>
        {description}
      </p>
    </div>
  ...
  <Card className="group h-full rounded-[28px] border-border bg-white transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(16,24,40,0.08)]" data-testid={`product-card-${index}`}>
    <CardContent className="flex h-full flex-col p-7">
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        {product.fit.map((tag) => (
          <span key={tag} className="rounded-full border border-border px-3 py-1 text-xs font-medium text-primary" data-testid={`product-tag-${index}-${tag.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`}>
            {tag}
          </span>
        ))}
      </div>
...
const InsightCard = ({ post, index }) => (
  <Card className="h-full rounded-[28px] border-border bg-white shadow-[0_16px_50px_rgba(16,24,40,0.05)]" data-testid={`insight-card-${index}`}>
    <CardContent className="flex h-full flex-col p-7">
      ...
      <div className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-primary" data-testid={`insight-readmore-${index}`}>
        Strategic insight
    ...
    <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:px-8 lg:py-24">
      <div className="space-y-7" data-testid={testId}>
        ...
        <div className="flex flex-wrap gap-3">
          {badges.map((badge) => (
            <span key={badge} className="rounded-full border border-border bg-muted px-4 py-2 text-sm font-medium text-primary" data-testid={`hero-badge-${badge.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`}>
              {badge}
            </span>
          ))}
        </div>
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:px-8 lg:py-24">
        <div className="space-y-8" data-testid="home-hero-content">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button asChild variant="outline" className="h-12 rounded-full border-primary px-6 text-primary hover:bg-primary hover:text-white" data-testid="home-secondary-cta-button">
        ...
        <ImagePanel
          ...
          overlay={
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-[24px] border border-white/30 bg-primary p-5 text-white shadow-[0_16px_50px_rgba(15,23,42,0.12)]" data-testid="home-hero-overlay-card-2">
    ...
    <section className="bg-muted py-20 lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8 lg:items-center">
        ...
        <div className="space-y-6" data-testid="home-about-content">
          ...
          <Button asChild className="h-12 rounded-full bg-primary px-6 text-white hover:bg-primary/90" data-testid="home-about-cta-button">
          ...
          {processSteps.map((step, index) => (
            <div key={step.title} className="rounded-[28px] border border-border bg-white p-6 shadow-[0_12px_40px_rgba(16,24,40,0.05)]" data-testid={`process-step-card-${index}`}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-heading text-2xl font-semibold text-foreground">{step.title}</p>
    ...
    <section className="bg-secondary py-20 text-white lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:items-start">
        <div className="space-y-6" data-testid="home-cta-content">
          ...
          <div className="flex flex-wrap gap-4">
            <Button asChild className="h-12 rounded-full bg-accent px-6 text-white hover:bg-accent/80" data-testid="home-final-call-button">
              <a href={`tel:${company.phoneRaw}`}>Call {company.phoneDisplay}</a>
            </Button>
            <Button asChild variant="outline" className="h-12 rounded-full border-white/30 bg-transparent px-6 text-white hover:bg-white hover:text-secondary" data-testid="home-final-contact-button">
...
const ProductsPage = () => (
  <>
    <PageHero
      ...
      primaryCta={
        <Button asChild className="h-12 rounded-full bg-primary px-6 text-white hover:bg-primary/90" data-testid="products-hero-primary-button">
          <Link to="/contact">Request a product discussion</Link>
        </Button>
      }
      secondaryCta={
        <Button asChild variant="outline" className="h-12 rounded-full border-primary px-6 text-primary hover:bg-primary hover:text-white" data-testid="products-hero-secondary-button">
...
const ServicesPage = () => (
  <>
    <PageHero
      ...
      primaryCta={
        <Button asChild className="h-12 rounded-full bg-primary px-6 text-white hover:bg-primary/90" data-testid="services-hero-primary-button">
          <Link to="/contact">Discuss a service requirement</Link>
        </Button>
      }
      secondaryCta={
        <Button asChild variant="outline" className="h-12 rounded-full border-primary px-6 text-primary hover:bg-primary hover:text-white" data-testid="services-hero-secondary-button">
...
const BlogPage = () => (
  <>
    <PageHero
      ...
      primaryCta={
        <Button asChild className="h-12 rounded-full bg-primary px-6 text-white hover:bg-primary/90" data-testid="blog-hero-primary-button">
          <Link to="/contact">Request a conversation</Link>
        </Button>
      }
      secondaryCta={
        <Button asChild variant="outline" className="h-12 rounded-full border-primary px-6 text-primary hover:bg-primary hover:text-white" data-testid="blog-hero-secondary-button">
...
const ContactPage = () => (
  <>
    <PageHero
      ...
      primaryCta={
        <Button asChild className="h-12 rounded-full bg-accent px-6 text-white hover:bg-accent/80" data-testid="contact-hero-primary-button">
          <a href={`tel:${company.phoneRaw}`}>Call {company.phoneDisplay}</a>
        </Button>
      }
      secondaryCta={
        <Button asChild variant="outline" className="h-12 rounded-full border-primary px-6 text-primary hover:bg-primary hover:text-white" data-testid="contact-hero-secondary-button">
    ...
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="space-y-6" data-testid="contact-info-content">
          ...
          <div className="rounded-[32px] border border-border bg-primary p-8 text-white" data-testid="contact-address-card">
