...
export const InsightCard = ({ post }: { post: InsightPost }) => (
  ...
  >
    <Card className="h-full rounded-[28px] border-border bg-surface-card shadow-[0_16px_50px_rgba(16,24,40,0.05)] transition duration-300 group-hover:-translate-y-1 group-hover:shadow-[0_24px_60px_rgba(16,24,40,0.09)] overflow-hidden">
      {post.img && (
